...
void setup()
{
    ...
    Serial.begin(115200);
    dht.begin();
    pinMode(PHOT_PIN, INPUT); // Set photoresistor pin to input
    Wire.begin(); // Start I2C bus

    if (AQ_sensor.begin() == false)
    {
...
void loop()
{
  ...
  else if (millis() > next_telemetry_send_time_ms)
  {
    ...
    photores = analogRead(PHOT_PIN);
    Serial.println(photores);

    AQ_reading = AQ_sensor.getVOCindex();
    Serial.println(AQ_reading); //Get the VOC Index using the default RH (50%) and T (25C)
